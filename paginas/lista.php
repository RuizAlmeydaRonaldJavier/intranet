        ...
        <div class="pt-1 pb-0" id="breadcrumbs-wrapper">
          <div class="container">
            <div class="row">
              ...
              <!-- BEGIN: Titulo de la página -->
              <div class="col s12 m6 l6">
                <h5 class="breadcrumbs-title"><span>DataTable</span></h5>
              </div>
              <!-- END: Titulo de la página -->

              <!-- BEGIN: Links de navegación -->
        ...
        <div class="col s12">
          <div class="container">
            <div class="section section-data-tables">
              ...
              <!-- BEGIN: Introducción a la sección -->
              <!--<div class="card">
